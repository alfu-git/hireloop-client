  ...
  return (
    ...
    >
      ...
      {expectedCompany?.status === "Approved" ? (
        ...
        <div className="p-6">Please wait to get approval.</div>
      )}
    </div>
  );
};
